...
class MonstersControllerTest < ActionController::TestCase
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post :create, monster: { element: @monster.element, info: @monster.info, name: @monster.name, species: @monster.species, weakness: @monster.weakness }
    end
  ...
  test "should update monster" do
    patch :update, id: @monster, monster: { element: @monster.element, info: @monster.info, name: @monster.name, species: @monster.species, weakness: @monster.weakness }
    assert_redirected_to monster_path(assigns(:monster))
  end
